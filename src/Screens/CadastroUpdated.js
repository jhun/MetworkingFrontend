...
const CadastroUpdated = (props) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>Cadastro atualizado com sucesso!</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => props.navigation.navigate("Met Timeline")}
      >
...
export default CadastroUpdated;
